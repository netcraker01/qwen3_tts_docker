...
# Note: flash-attn requires CUDA devel image with nvcc compiler
# For production, we skip flash-attn to use standard attention
# To enable flash-attn, use nvidia/cuda:12.1.1-devel-ubuntu22.04 instead
